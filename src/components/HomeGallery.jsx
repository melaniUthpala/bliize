...
import modernArchitecture from '../assets/homeinbt/modern-architecture.jpg';
import classicArchitecture from '../assets/homeinbt/classic-architecture.jpg';
import modernArchitectureS2 from '../assets/homeinbt/modern-architecture-s2.jpg';
import classicArchitectureDark from '../assets/homeinbt/classic-architecture-dark.jpg';
...
const demos = [
  ...
  { title: 'Classic Architecture Dark', img: classicArchitectureDark },
...
export default function HomeGallery({ onNavigate }) {
  return (
    <section className="gallery-sec">
      ...
      <div className="gallery-grid">
        {demos.map((demo, i) => (
<div key={i} className="gallery-card" onClick={() => onNavigate(i === 0 ? 'original-home' : 'coming-soon')}>
